    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
      {people.map((person) => (
        <button
          ...
          className="bg-white rounded-2xl p-6 hover:shadow-md transition-all border border-gray-100 hover:border-hinted-200 text-left group"
        >
          <div className="flex items-start gap-4">
            <div className="w-12 h-12 bg-hinted-100 rounded-full flex items-center justify-center flex-shrink-0 group-hover:bg-hinted-200 transition-all">

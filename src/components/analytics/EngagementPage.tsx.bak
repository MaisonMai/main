    ...
    return (
      <div className="space-y-6">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-8 text-center">
          ...
          <p className="text-slate-600 text-sm">Detailed engagement metrics will be available once event tracking is fully implemented. Currently showing data from the Overview tab.</p>
        </div>
      </div>
    );
  }
